...
public class OperationalController {
    ...
    private OperationalRoomDto mapToRoomDto(RoomNumber rn) {
        return OperationalRoomDto.builder()
                ...
                .roomName(rn.getRoom() != null ? rn.getRoom().getName() : null)
                .hotelId(rn.getRoom() != null && rn.getRoom().getHotel() != null ? rn.getRoom().getHotel().getId() : null)
                .hotelName(rn.getRoom() != null && rn.getRoom().getHotel() != null ? rn.getRoom().getHotel().getName() : null)
                .build();
    }
    ...
    private MaintenanceTicketDto mapToTicketDto(MaintenanceTicket ticket) {
        ...
        return MaintenanceTicketDto.builder()
                ...
                .roomName(rn != null && rn.getRoom() != null ? rn.getRoom().getName() : null)
                .hotelName(rn != null && rn.getRoom() != null && rn.getRoom().getHotel() != null ? rn.getRoom().getHotel().getName() : null)
    ...
    public ResponseEntity<?> resolveCleaning(@RequestParam Long roomNumberId) {
        ...
        String roomNameStr = rn.getRoom() != null ? rn.getRoom().getName() : "Unknown Category";
